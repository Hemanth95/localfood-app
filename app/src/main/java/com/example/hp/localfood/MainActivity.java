...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String message = tt.getText().toString();
        ...
        Button btn1 = (Button) findViewById(R.id.upc1) ;
    ...
    if (id==R.id.stchat){
        ...
        Intent st = new Intent(MainActivity.this,streetpg.class);
        startActivity(st);
    }
    else if(id==R.id.ff){
        Intent fast = new Intent(MainActivity.this,Fast_food.class);
        startActivity(fast);
    }
