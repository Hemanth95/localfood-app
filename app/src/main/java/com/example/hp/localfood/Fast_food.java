...
public class Fast_food extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(Fast_food.this, cart.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id==R.id.stchat){
            ...
            Intent st = new Intent(Fast_food.this,streetpg.class);
            startActivity(st);
        }
        else if(id==R.id.ff){
            Intent fast = new Intent(Fast_food.this,Fast_food.class);
            startActivity(fast);
        }
        else if(id==R.id.htls){
            Intent rest = new Intent(Fast_food.this,Restaurants.class);
            startActivity(rest);
        }
        else if(id==R.id.ss){
